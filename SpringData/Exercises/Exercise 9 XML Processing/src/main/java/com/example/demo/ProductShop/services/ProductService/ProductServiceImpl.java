...
import com.example.demo.ProductShop.dtos.Product.Wrapper.ProductWithNoBuyerWrapperDTO;
...
public class ProductServiceImpl implements ProductService {
    ...
    @Override
    @Transactional
    public List<ProductWithNoBuyerDTO> findAllByPriceBetweenAndBuyerIsNullOrderByPrice(BigDecimal low, BigDecimal high) throws IOException, JAXBException {
        ...
        ProductWithNoBuyerWrapperDTO productWrapperDTo = new ProductWithNoBuyerWrapperDTO(products);
        writeXmlIntoFile(productWrapperDTo,PRODUCTS_IN_RANGE_XML_PATH);
        return products;
    }
}
