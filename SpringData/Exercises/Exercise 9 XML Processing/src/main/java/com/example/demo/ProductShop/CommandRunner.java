...
//1.	Products Shop
        //Query 1 – Products in Range. After you run the query below you will fill the files/outputXML/product-in-range
//        this.productService.findAllByPriceBetweenAndBuyerIsNullOrderByPrice(BigDecimal.valueOf(500),BigDecimal.valueOf(1000));

        //Query 2 – Successfully Sold Products. After you run the query below you will fill the files/outputXML/users-sold-products
 //       this.userService.findAllBySellingProductsBuyerIsNotNull();

        //Query 3 – Categories by Products Count. After you run the query below you will fill the files/outputXML/categories-by-products.json
 //       this.categoryService.getCategorySummary();

        //Query 4 – Users and Products. After you run the query below you will fill the files/outputXML/users-and-products.json
